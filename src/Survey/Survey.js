...
function Survey() {
  ...
  const programming_languages = [ 'html', 'css', 'javascript', 'react', 'node', 'python']
  ...
  return (
    <React.Fragment>
      ...
      <p className="servey-request">
        Please complete the survey to help us improve our service, website, and others. We will not share your information with anyone. Thank you for your support.
      </p>

    <form className="survey-form">
      <div className="survey-form-device-group">
      <p className="survey-topic">What device did you use to access the website? </p>
      <div>
        <input
          type="radio"
          value="desktop"
      ...
      <p className="survey-topic">What programming languages are you interested?</p>
      <select className="survey-interest-selection" onChange={interest_menu}>
          {programming_languages.map((language, index) => {
            return ( 
              <option className="survey-interest-option" key={index} value={language}>{language}</option> 
            )
          })}
      </select>
      </div>
      <div className="survey-form-rating-group">
      <p className="survey-topic">Are you satisfied that you found out the website?</p>
      <div>
        <input
          type="radio"
