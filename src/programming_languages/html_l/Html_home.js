  ...
  return (
    <>
      <div id="container">
        ...
        <div id="middle">
          <h3> Welcome to the HTML home page.</h3>
          
          <p>
            This is the home page for the HTML programming language. In this page, you can find information about the language, its syntax, and its history.
          </p>
...
<li>Then comes HTML 3.0, where Dave Raggett introduced a fresh paper or draft on HTML. It included improved new features of HTML, giving more powerful characteristics for webmasters in designing web pages. But these powerful features of the new HTML slowed down the browser in applying further improvements.</li>
<li>Then comes HTML 4.01, which is widely used and was a successful version of HTML before HTML 5.0, which is currently released and used worldwide. HTML 5 can be said for an extended version of HTML 4.01, which was published in the year 2012.
